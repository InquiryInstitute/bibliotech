...
-- Fixed version that handles existing faculty table with TEXT id

-- Create faculty table (if it doesn't exist)
-- If faculty already exists with TEXT id, we'll use TEXT for faculty_id in books
...
-- Create books table with faculty_id matching faculty.id type
